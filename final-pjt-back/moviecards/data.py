...
extra_settings = [
        {"skill_type": "nuff", "skill_range": 20, "skill_comment": "얼어 붙어라!", "attack_damage" : 0, "hp": 0, "description":"보스에게 20의 피해를 주고 빙결 상태로 만듭니다."},
        {"skill_type": "draw", "skill_range": 2, "skill_comment": "나는 밑에서 한장 너는 위에서 한장", "attack_damage": 0, "hp":0, "description": "카드를 두 장 뽑습니다."},
        {"skill_type": "others", "skill_range": 0, "skill_comment": "나는 필연적 존재이다!", "attack_damage": 0, "hp":0, "description":"플레이어와 보스 중 한명의 체력이 반으로 줄어듭니다."},
        {"skill_type": "others", "skill_range": 0, "skill_comment": "Manners maketh man", "attack_damage": 0, "hp":0, 'description' : "이번턴에 추가 액션을 획득합니다."},
        ...
        {"skill_type": "heal", "skill_range": 30, "skill_comment": "프로틴-바", "attack_damage": 0, "hp": 0, 'description' : "플레이어의 체력이 +30 증가합니다."},
        {"skill_type": "buff", "skill_range": 10, "skill_comment": "I am Iron man", "attack_damage": 0, "hp": 0, 'description' : "모든 하수인의 공격력이 +10 됩니다."},
        {"skill_type": "others", "skill_range": 0, "skill_comment": "백엔드의 신", "attack_damage": 50, "hp": 100, 'description' : "DB를 조작해 즉시 공격이 가능합니다."},
        ...
        {"skill_type": "others", "skill_range": 0, "skill_comment": "키미노 나마에와", "attack_damage": 0, "hp": 0, 'description' : "하수인을 선택합니다. 보스와 이름을 바꿉니다. 10의 생명력과 공격력을 얻습니다."},
        {"skill_type": "others", "skill_range": 5, "skill_comment": "하지만, 내가 돌아가면, 다시 날씨가..!", "attack_damage": 0, "hp": 0, 'description' : "필드가 바뀝니다. 보스의 공격력이 5만큼 감소합니다."},
        ...
        {"skill_type": "others", "skill_range": 0, "skill_comment": "누가 50이야?", "attack_damage": 40, "hp": 100, 'description' : "그냥 강합니다."},
        ...
        {"skill_type": "buff", "skill_range": 25, "skill_comment": "작별인사는 하고 가야지", "attack_damage": 0, "hp": 0, 'description' : "하수인을 선택합니다. 이번턴 하수인의 공격력이 +25 증가합니다."},
        ...
        {"skill_type": "others", "skill_range": 0, "skill_comment": "두려움은 직시하면 그 뿐. 바람은 계산하는 것이 아니라 극복하는 것이다.", "attack_damage": 0, "hp": 0, 'description' : "보스의 체력이 30 이하라면 즉사합니다. 아니라면 10의 데미지를 줍니다."},
